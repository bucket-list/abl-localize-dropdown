...
module.exports = {
  ...
  entry: path.resolve(__dirname, 'src/abl-localize-dropdown.js'),

  //  Bundle to ./dst.
  output: {
    path: path.resolve(__dirname, 'dst'),
    filename: 'abl-localize-dropdown.js'
  },
  ...
  plugins: [
    new ExtractTextPlugin(path.resolve(__dirname, 'src/abl-localize-dropdown.css')),
